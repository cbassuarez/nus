...
impl super::Surface {
    pub fn new(layer: Retained<CAMetalLayer>) -> Self {
        Self {
            ...
            #[cfg(target_os = "macos")]
            has_been_visible: core::sync::atomic::AtomicBool::new(false),
        }
    }
...
impl crate::Surface for super::Surface {
    ...
    unsafe fn acquire_texture(
        ...
        #[cfg(target_os = "macos")]
        {
            ...
            // A new window has a stale occlusion state until its first frame.
            // Preserve the post-visibility guard for minimized/covered windows.
            // Backport: https://github.com/gfx-rs/wgpu/pull/10302
            use objc2::rc::Retained;
